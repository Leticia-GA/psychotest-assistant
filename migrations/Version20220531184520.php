 ...
 */
final class Version20220531184520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clinic (id INT AUTO_INCREMENT NOT NULL, info VARCHAR(200) NOT NULL, phone_number VARCHAR(20) NOT NULL, email VARCHAR(180) NOT NULL, location VARCHAR(200) NOT NULL, opening_hours VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, psychologist_id INT DEFAULT NULL, phone_number VARCHAR(20) NOT NULL, diagnostic LONGTEXT DEFAULT NULL, case_history LONGTEXT DEFAULT NULL, INDEX IDX_1ADAD7EBFE8EF269 (psychologist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE psychologist (id INT NOT NULL, phone_number VARCHAR(20) NOT NULL, education VARCHAR(200) NOT NULL, specialization VARCHAR(200) NOT NULL, collegiate_number VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_FFC468E062F9D51F (collegiate_number), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(200) NOT NULL, explanation LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, surnames VARCHAR(250) NOT NULL, dni VARCHAR(30) NOT NULL, birth_date VARCHAR(20) NOT NULL, email VARCHAR(180) NOT NULL, photo VARCHAR(100) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, discr VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
